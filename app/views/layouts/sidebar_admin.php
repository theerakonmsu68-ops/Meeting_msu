...
body:has(.sidebar.admin-sidebar:not(.collapsed))
.main-content {
    margin-left: 268px;
...
body:has(.sidebar.admin-sidebar.collapsed)
.main-content {
    margin-left: 74px;
...
/* =========================================================
   SAFE AREA - IPHONE / NOTCHED DEVICES
   ========================================================= */
