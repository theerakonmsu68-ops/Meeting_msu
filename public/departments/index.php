...
require_once APP_PATH . '/helpers/status_helper.php';
...
$stmtStats = $db->prepare(
    "SELECT
        ...
        SUM(CASE WHEN m.meeting_date = CURDATE() THEN 1 ELSE 0 END) AS today_count
...
$page_title = 'ศูนย์งานประชุมภาควิชา';

$page_css = "department-dashboard.css";
...
include_once APP_PATH . '/views/layouts/sidebar_department.php';
?>
...
<div class="main-content" id="mainContent">
    <header class="department-header">
        <div style="display:flex; align-items:center; gap:12px; min-width:0;">
            ...
            <div style="min-width:0;">
                <h2 style="margin:0;display:flex;align-items:center;gap:8px;color:#1e293b;font-size:20px;">
                    <i data-lucide="building-2" style="width:22px;color:#0284c7;"></i>
                    ศูนย์งานประชุมภาควิชา
                </h2>
        ...
        <div class="department-user-card">
            <div
                style="width:34px;height:34px;border-radius:10px;background:#f0f9ff;color:#0284c7;display:flex;align-items:center;justify-content:center;">
            ...
            <main>
                <section class="card">
                    <div class="card-title-row">
                        ...
                        <a href="calendar.php"
                            style="font-size:12px;color:#0284c7;text-decoration:none;font-weight:700;">ดูปฏิทินทั้งหมด</a>
                    </div>
...
window.MeetingConfig = {
    ...
    apiUrl: '<?= BASE_URL ?>app/controllers/department_meeting_api.php'
};
</script>
